...
{  
    ...
    {
        public ApplicationUserStore(AlgrmsWebContext context)
            : base(context)
        {
        }
    }
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, int>    
    {
        ...
        {
            var manager = new ApplicationUserManager(new ApplicationUserStore( context.Get<AlgrmsWebContext>()));
        ...
        {
            return GetUser(new AlgrmsWebContext(), _userId);
        }

        public static ApplicationUser GetUser(AlgrmsWebContext db, int _userId)
        {
        ...
        public static List<ApplicationUser> GetUsers()
        {
            ...
            try
            {
                using (AlgrmsWebContext db = new AlgrmsWebContext())
                {
    ...
    {
        public ApplicationRoleStore(AlgrmsWebContext context)
            : base(context)
        {
        }
    }
    ...
    public class ApplicationRoleManager : RoleManager<ApplicationRole, int>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<ApplicationRole, int, ApplicationUserRole>(context.Get<AlgrmsWebContext>()));          
        }
        ...
        public static List<ApplicationRole> GetRoles()
        {
            ...
            try
            {
                using (RoleStore<ApplicationRole, int, ApplicationUserRole> db = new RoleStore<ApplicationRole, int, ApplicationUserRole>(new AlgrmsWebContext()))
                {
        ...
        public static bool CreateRole(ApplicationRole _role)
        {
            ...
            try
            {                
                var roleManager = new RoleManager<ApplicationRole, int>(new RoleStore<ApplicationRole, int, ApplicationUserRole>(new AlgrmsWebContext()));
